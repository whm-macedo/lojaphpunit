...
<div class="jumbotron">
  ...
  <div class="col-lg-12 text-center mt-5">
    <h3 class="section-heading text-uppercase">Veja como você pode ajudar </h3>
    <div class="section-heading text-uppercase">você pode ajudar se dirijindo a uma unidade mais próxima,
      (verificando no mapa) ou verificar em qual unidade está com o seu estoque em menor quantidade.<p>
        assim você garante todos os benificios tanto para sua você, quanto para o seu próximo.</p>
      <h3 class="section-heading text-uppercase">ENTREGA RAPIDA E SEGURA</h3>
      <div class="section-heading text-uppercase">
        Voluntario e doadores tem direito a frete diferenciado
        O nosso frete diferenciado e composto pela rede de voluntários, que podem fazer a entrega para outros companheiros que trabalhem ou residam próximo a ele.
        mas também contamos como o sedex, mercado pago, dentre outros
      </div>
      <h3 class="section-heading text-uppercase">ENTREGA RAPIDA E SEGURA</h3>
      <div class="section-heading text-uppercase">Voluntario e doadores tem direito a frete diferenciado
        O nosso frete diferenciado e composto pela rede de voluntários, que podem fazer a entrega para outros companheiros que trabalhem ou residam próximo a ele.
        mas também contamos como o sedex, mercado pago, dentre outros
      </div>
    </div>
    <h3 class="section-heading text-uppercase">PRODUTOS UNICOS</h3>
    <div class="section-heading text-uppercase">Produtos totalmente personalizados com marca do projeto DOE+, com incentivo de juntar novos doadores.
      e garantimos que os nosso produtos personalisados com a nossa logo sejam somente para doadores ou voluntarios, assim formamos um grande rede de amigos de sangue.
    </div>
  </div>
</div>
