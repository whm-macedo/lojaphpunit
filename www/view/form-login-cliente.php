...
<form class="form-signin" method="post" action="">
    ...
    <input type="nome" id="nome" class="form-control" placeholder="Usuário" required="" autofocus="">
    ...
    <button id="cadastrar" name="cadastrar" class="btn btn-lg btn-primary btn-block mt-3 formadm">Login</button>
